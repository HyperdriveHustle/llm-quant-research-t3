...
The final immutable-HEAD real run `run_20260826_093911_1862939f` used nine model calls, five factor evaluations and three recorded invalid/repair turns. Search selected `REV1R` with IC 0.0286427 and RankIC 0.0498399; independent search recomputation matched exactly. Hidden 2023Q2 OOS IC was -0.0069480 and RankIC -0.0005724, both sign-reversed; OOS IC was 0.0178039 below the best hidden seed. The correct verdict is therefore: protocol and pipeline success, but `research_outcome.status=not_supported_hidden_oos`.
